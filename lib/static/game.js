...
const gameContainer = svg.append('rect')
.attr('width', parseInt(wwidth * 0.7))
.attr('height', parseInt(wheight * 0.7))
.attr('fill', 'blue')
.attr('stroke', 'red')
...
// Ball letter color contrast comparison
