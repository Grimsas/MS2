...
function titleToBackGround(){
  titleG.selectAll('text').transition().duration(2000).ease(d3.easeBackIn).attr('opacity', 0.1).attr('y', gameContainerHeight - buttonRadius/3)
}
