...
let dictionaryA = function () {
    for(let i=0;i<commonWord.length;i++){
    dictionaryAll.push(commonWord[i].val);
 }
 return console.log('dictionaryAll: Done!') 
} // .map was way too slow
...
let textclr ={
letter: "a", textcolor: "#FFF",
letter: "b", textcolor: "#000",
letter: "c", textcolor: "#000",
letter: "d", textcolor: "#000",
letter: "e", textcolor: "#000",
letter: "f", textcolor: "#000",
letter: "g", textcolor: "#FFF",
letter: "h", textcolor: "#FFF",
letter: "i", textcolor: "#FFF",
letter: "j", textcolor: "#FFF",
letter: "k", textcolor: "#FFF",
letter: "l", textcolor: "#FFF",
letter: "m", textcolor: "#000",
letter: "n", textcolor: "#000",
letter: "o", textcolor: "#FFF",
letter: "p", textcolor: "#FFF",
letter: "q", textcolor: "#000",
letter: "r", textcolor: "#FFF",
letter: "s", textcolor: "#FFF",
letter: "t", textcolor: "#FFF",
letter: "u", textcolor: "#FFF",
letter: "v", textcolor: "#000",
letter: "w", textcolor: "#000",
letter: "x", textcolor: "#FFF",
letter: "y", textcolor: "#FFF",
letter: "z", textcolor: "#FFF"
}
...
function meep (e){
    let ballTextCo  = ballColArr.find(c => c.letter === e)
}
...
function rndDxDy(min, max) {
  ...
  if ((number <= -2 && number >= min) || (number >= 2 && number <= max)) {
    return number;
...
// function ballTextColor(letter){
//   let arr = ballColArr
//   arr.find(function(arr) {
//     if(arr.letter == letter)
//       return arr.textcolor;
//   });
// }
...
function ball (letter) {
    ...
    this.textcolor = function() {let value = ballColArr[this.letter].textcolor
    return value}
    ...
    let text = ballsGroup.selectAll('#' + this.letter+'-letter')
      ...
      text.enter().append('text')
        ...
        .attr('class', 'balltext')
        .style('fill', this.textcolor(this.letter))
        // 
      text
        .text(this.letter)
        .attr('x', this.cx)
...
//d3.select('#balls').selectAll('#t')  .transition().ease(d3.easeExpInOut).duration(3000).attr('r', 0);
